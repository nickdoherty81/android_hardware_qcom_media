...
libmm-vdec-inc          += $(TOP)/$(call project-path-for,qcom-media)/msm8996/mm-video-v4l2/vidc/common/inc
libmm-vdec-inc          += $(TOP)/$(call project-path-for,qcom-media)/msm8996/mm-core/inc
...
libmm-vdec-inc      	+= $(TOP)/$(call project-path-for,qcom-media)/msm8996/libc2dcolorconvert
...
libmm-vdec-inc += $(TOP)/$(call project-path-for,qcom-media)/msm8996/libstagefrighthw
endif
