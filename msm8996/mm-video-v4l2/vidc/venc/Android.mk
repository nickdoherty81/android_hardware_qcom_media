...
libmm-venc-inc      += $(TOP)/$(call project-path-for,qcom-media)/msm8996/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += $(call project-path-for,qcom-media)/msm8996/mm-core/inc
libmm-venc-inc      += $(call project-path-for,qcom-media)/msm8996/libstagefrighthw
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/qcom/display
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += frameworks/native/include/media/hardware
libmm-venc-inc      += frameworks/native/include/media/openmax
libmm-venc-inc      += $(call project-path-for,qcom-media)/msm8996/libc2dcolorconvert
